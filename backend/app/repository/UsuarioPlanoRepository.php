...
class UsuarioPlanoRepository
{
    ...
    {
        $stmt = $this->getConnection()->prepare('CALL USUARIO_PLANO_CONTROLLER(:acao, :param_usuario_email, :param_plano_id, :param_plano_nome, :param_data_inicial, :param_data_final)');
        $stmt->execute([
            ':acao' => 'add',
    ...
    {
        $stmt = $this->getConnection()->prepare('CALL USUARIO_PLANO_CONTROLLER(:acao, NULL, NULL, NULL, NULL, NULL)');
    ...
    {
        $stmt = $this->getConnection()->prepare('CALL USUARIO_PLANO_CONTROLLER(:acao, :param_usuario_email, :param_plano_id, :param_plano_nome, NULL, NULL)');
        $stmt->execute([
            ':acao' => 'delete',
            ':param_usuario_email' => $usuario_email,
            ':param_plano_id' => $plano_id,
